...
namespace FindTheMonkey
{
	...
	{
		static readonly string uuid1 = "7ACF319-9EC8-50FE-820F-A10AEAFA68E2";
		static readonly string monkeyId1 = "Monkey1";

		static readonly string uuid2 = "F4657573-9F765286-CBA7-D42133F532AE";
		static readonly string monkeyId2 = "Monkey2";

		static readonly string uuid3 = "D7E6D915-BA77-1A16642B-8064F3DD3210";
		static readonly string monkeyId3 = "Monkey3";
		...
		public override void ViewDidLoad ()
		{
			...
			var monkeyUUID = new NSUuid (uuid1);
			var beaconRegion = new CLBeaconRegion (monkeyUUID, monkeyId1);
			...
			if (!UserInterfaceIdiomIsPhone) {
				...
				locationMgr.RegionEntered += (object sender, CLRegionEventArgs e) => {
					if (e.Region.Identifier == monkeyId1) {
